...
class Produto(models.Model):
    ...
    imagem = models.ImageField(help_text='Imagem do produto', upload_to='project/static/images/')

    choices = (("Camisa", "Camisa"),
        ("Calça", "Calça"),
        ("Sapato", "Sapato"),
        ("Vestido", "Vestido"),)

    categoria = models.CharField(max_length=50, choices=choices, help_text='Categoria do produto')
